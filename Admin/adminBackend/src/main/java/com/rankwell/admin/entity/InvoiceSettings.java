...
public class InvoiceSettings { 
	...
	public InvoiceSettings(Long id, String invoiceGST, String invoicePrefix, String invoiceYear, String invoiceSuffix, Long invoiceDiscount, Long invoiceTaxRate, boolean updateSerialNo) {
		super();
		this.id = id;
		this.invoiceGST = invoiceGST;
		this.invoicePrefix = invoicePrefix;
