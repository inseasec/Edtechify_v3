...
public class OAuthConfig {
	...
	@Column(name = "user_google_instructions", columnDefinition = "TEXT")
	private String userGoogleInstructions;

	@Column(name = "user_facebook_instructions", columnDefinition = "TEXT")
	private String userFacebookInstructions;

	@Column(name = "user_github_instructions", columnDefinition = "TEXT")
	private String userGithubInstructions;
	...
	public String getUserGoogleInstructions() {
		return userGoogleInstructions;
	}

	public void setUserGoogleInstructions(String userGoogleInstructions) {
		this.userGoogleInstructions = userGoogleInstructions;
	}

	public String getUserFacebookInstructions() {
		return userFacebookInstructions;
	}

	public void setUserFacebookInstructions(String userFacebookInstructions) {
		this.userFacebookInstructions = userFacebookInstructions;
	}

	public String getUserGithubInstructions() {
		return userGithubInstructions;
	}

	public void setUserGithubInstructions(String userGithubInstructions) {
		this.userGithubInstructions = userGithubInstructions;
	}
}
