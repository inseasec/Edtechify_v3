                  ...
                  {paginatedApplicants.map((item) => (
                    ...
                    >
                      <td className="px-2 py-2">
                        <ApplicantTableNameCell row={item} />
                      </td>
                      <td className="px-2 py-2 text-slate-600">{item.phone ?? '—'}</td>
                      <td
                        className="max-w-[14rem] truncate px-2 py-2 text-slate-600"
                        title={formatAppliedRole(item)}
                      >
                        {formatAppliedRole(item)}
                      </td>
                      {!isHR && <td className="px-2 py-2 text-slate-600">{item.maritalStatus ?? '—'}</td>}
                      <td className="px-2 py-2 text-slate-600">{item.city ?? '—'}</td>
                      {!isHR && <td className="px-2 py-2 text-slate-600">{calculateAge(item.dob) ?? '—'}</td>}
